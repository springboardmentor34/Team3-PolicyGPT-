...
loadPolicies(keyword?: string): void {
  ...
  // Policy Approval Workflow (Task 4): public_only=true keeps
  // Pending/Rejected policies out of citizen-facing search results.
  this.policyService.getAllPolicies({ ...(keyword ? { keyword } : {}), public_only: true }).subscribe({
