...
def compare_policies(
    ...
    policy1 = db.query(Policy).filter(Policy.policy_id == policy1_id).first()
    policy2 = db.query(Policy).filter(Policy.policy_id == policy2_id).first()
...
def compare_schemes(
    ...
    scheme1 = db.query(Scheme).filter(Scheme.scheme_id == scheme1_id).first()
    scheme2 = db.query(Scheme).filter(Scheme.scheme_id == scheme2_id).first()
